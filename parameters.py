...
DICTIONARY_FILE = 'data/cnn_dataset/dictionary2.model'
DATA_FILE = 'data/cnn_dataset/train_processed2.data'
VAL_FILE = 'data/cnn_dataset/val_processed2.data'
