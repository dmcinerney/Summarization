...
sections = [
    ...
    dict(max_training_steps=231000, max_text_length=400, max_summary_length=100, with_coverage=True, batch_size=2),
    dict(max_training_steps=232000, max_text_length=400, max_summary_length=100, with_coverage=True, batch_size=2),
